...
def plot_user_week_analysis(weekly_averages, cleaned_averages, averages_no_power, sorted_weeks):
    ...
    # Save plots
    plt.savefig('philippines/user_week_analysis_may_aug_2024.png', dpi=300, bbox_inches='tight')
    plt.savefig('philippines/user_week_analysis_may_aug_2024.pdf', bbox_inches='tight')
    
    print("\nUser-week analysis plots saved as 'philippines/user_week_analysis_may_aug_2024.png/.pdf'")
...
def save_user_week_analysis(weekly_averages, cleaned_averages, averages_no_power, 
    ...
    with open('philippines/user_week_analysis_may_aug_2024.json', 'w') as f:
        json.dump(output_data, f, indent=2)
    
    print("User-week analysis results saved as 'philippines/user_week_analysis_may_aug_2024.json'")
...
def print_analysis_summary(weekly_averages, cleaned_averages, averages_no_power, 
    ...
    print("=" * 80)
    print("USER-WEEK ANALYSIS - PHILIPPINES GITHUB USERS (MAY-AUG 2024)")
