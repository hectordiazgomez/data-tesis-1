...
def print_outliers_summary(analysis):
    ...
    print("=" * 60)
    print("WEEKLY COMMITS OUTLIERS ANALYSIS - bangladesh (MAY-AUG 2024)")
    print("=" * 60)
...
def plot_outliers(weekly_data, analysis):
    ...
    plt.title('Weekly Commits with Outliers Analysis - bangladesh (May-Aug 2024)', fontsize=16, fontweight='bold')
    ...
    # Save the plot
    plt.savefig('bangladesh/weekly_commits_outliers_may_aug_2024.png', dpi=300, bbox_inches='tight')
    plt.savefig('bangladesh/weekly_commits_outliers_may_aug_2024.pdf', bbox_inches='tight')
    print("\nOutliers plot saved as 'bangladesh/weekly_commits_outliers_may_aug_2024.png' and .pdf")
...
def save_outliers_data(analysis, weekly_data):
    ...
    with open('bangladesh/outliers_analysis_may_aug_2024.json', 'w') as f:
        json.dump(output_data, f, indent=2)
    
    print("Outliers analysis saved as 'bangladesh/outliers_analysis_may_aug_2024.json'")
