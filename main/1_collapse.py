...
def plot_weekly_commits(weekly_data):
    ...
    plt.title('Weekly Commits - bangladesh GitHub Users (2024)\n(Complete weeks only)', fontsize=16, fontweight='bold')
    ...
    # Save the plot
    plt.savefig('bangladesh/weekly_commits_2024_filtered.png', dpi=300, bbox_inches='tight')
    print("Plot saved as 'bangladesh/weekly_commits_2024_filtered.png'")
    
    # Also save as PDF for high quality
    plt.savefig('bangladesh/weekly_commits_2024_filtered.pdf', bbox_inches='tight')
    print("Plot saved as 'bangladesh/weekly_commits_2024_filtered.pdf'")
