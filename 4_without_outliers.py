...
def plot_weekly_without_outliers(filtered_weekly_data, removed_weeks):
    ...
    plt.title('Weekly Commits - Philippines (May-Aug 2024)\nOutlier Weeks >50% Removed', 
    ...
    # Save the plot
    plt.savefig('philippines/weekly_commits_no_outliers_may_aug_2024.png', dpi=300, bbox_inches='tight')
    plt.savefig('philippines/weekly_commits_no_outliers_may_aug_2024.pdf', bbox_inches='tight')
    
    print(f"\nWeekly plot (no outliers) saved as 'philippines/weekly_commits_no_outliers_may_aug_2024.png/.pdf'")
...
def plot_weekly_without_power_users(weekly_data_no_power, power_users_count):
    ...
    # Save the plot
    plt.savefig('philippines/weekly_commits_no_power_users_may_aug_2024.png', dpi=300, bbox_inches='tight')
    plt.savefig('philippines/weekly_commits_no_power_users_may_aug_2024.pdf', bbox_inches='tight')
    
    print(f"\nWeekly plot (no power users) saved as 'philippines/weekly_commits_no_power_users_may_aug_2024.png/.pdf'")
...
def save_analysis_summary(original_weekly_data, filtered_weekly_data, removed_weeks, weekly_data_no_power, power_users):
    ...
    with open('philippines/without_outliers_analysis_may_aug_2024.json', 'w') as f:
        json.dump(output_data, f, indent=2)
    
    print("\nAnalysis summary saved as 'philippines/without_outliers_analysis_may_aug_2024.json'")
